typeof navigator === "object" && (function (global, factory) {
  ...
  const vimeo = {
    ...
    ready() {
      ...
      const minOption = stime == 0 ? '' : '#' + parseInt(stime / 60) + 'm' + stime % 60 + 's';
      player.debug.log("StartTime! ", startTime, minOption); // Get Vimeo params for the iframe
      ...
      player.debug.log("SetSource:", src);
      ...
      player.media.currentTime = stime; // set startTime! (seems working...)
      //console.log("Set currentTime:",player.media.currentTime);
      ...
      Object.defineProperty(player.media, 'currentTime', {
        ...
        set(time) {
          console.log("Called viemo time set", time); // Vimeo will automatically play on seek if the video hasn't been played before
